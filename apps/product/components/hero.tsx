...
export default function Hero() {
  return (
    <section className="relative min-h-[680px] md:min-h-[760px] flex items-center overflow-hidden">
      ...
      <div
        className="absolute inset-0 bg-gradient-to-r from-[#060F1E]/95 via-[#0A1628]/80 to-[#060F1E]/40"
        aria-hidden="true"
      />

      {/* ── Bottom fade into next section ── */}
      <div
        className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#0A1628] to-transparent pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-36 pb-16 md:pb-24">
          <div className="max-w-2xl">
            ...
            {/* PCI badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00B4D8]/15 border border-[#00B4D8]/30 text-[#48CAE4] text-xs font-semibold uppercase tracking-wider mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-[#00B4D8] animate-pulse" aria-hidden="true" />
              POS para negocios hispanos en USA
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link
                className="btn text-white bg-[#00B4D8] hover:bg-[#0096B7] group shadow-lg shadow-[#00B4D8]/20"
                href="#contacto"
              >
