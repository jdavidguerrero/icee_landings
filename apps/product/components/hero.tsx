...
export default function Hero() {
  return (
    <section className="relative">
      {/* Bg */}
      <div
        className="absolute inset-0 rounded-bl-[100px] mb-28 md:mb-0 bg-[#0A1628] pointer-events-none -z-10"
        aria-hidden="true"
      />
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              <p className="text-lg text-slate-300 mb-8">
                La plataforma POS diseñada para negocios hispanos en Estados Unidos. Cobra con tarjeta, imprime
                recibos, y controla tu negocio — todo en español.
              </p>
              ...
              >
                <div>
                  <Link
                    className="btn-sm w-full inline-flex items-center text-white bg-[#00B4D8] hover:bg-[#0096B7] group shadow-xs"
                    href="#contacto"
                  >
                    Solicitar demo
                ...
                <div>
                  <Link
                    className="btn-sm w-full inline-flex items-center text-white bg-white/10 hover:bg-white/20 shadow-xs"
                    href="#como-funciona"
                  >
                    Ver cómo funciona
                  </Link>
            ...
            <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
              <div className="relative -ml-3 -mr-24 md:mx-0">
                ...
                />
                <Image
                  src="/images/icee_pos_nobg.png"
                  className="md:max-w-none"
                  style={{ height: 'auto' }}
                  width={548}
                  height={545}
                  sizes="(max-width: 640px) 90vw, (max-width: 1024px) 45vw, 548px"
                  alt="Terminal Icee POS todo-en-uno"
                  priority
                />
                {/* "Todo en Español" floating badge */}
                <div className="absolute bottom-16 md:bottom-20 left-4 z-10 flex items-center gap-2 bg-[#0A1628]/90 border border-[#00B4D8]/40 rounded-full px-3 py-1.5 backdrop-blur-sm shadow-lg shadow-black/30">
                  <span className="text-base leading-none" aria-hidden="true">🇪🇸</span>
                  <span className="text-xs font-semibold text-white whitespace-nowrap">100% en español</span>
