...
const brands: Brand[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'Base Cargadora i9000s', type: 'Periférico', description: 'Base de carga y comunicación para el Urovo i9000s. Permite carga y sincronización simultánea.', image: '/images/products/urovo/base-i9000s.png' },
    ],
  },
  {
    id: 'spectra',
  ...
  },
  {
    ...
    products: [
      { name: 'CS20', type: 'Terminal POS', description: 'Terminal Android con pantalla táctil 5", NFC, EMV y MSR. Diseño slim para comercios.', image: '/images/products/ciontek/cs20.png' },
      { name: 'CS30', type: 'Terminal POS', description: 'POS todo-en-uno con impresora integrada, pantalla 5.5" y conectividad 4G.', image: '/images/products/ciontek/cs30.png' },
      { name: 'CS30 Pro', type: 'Terminal POS', description: 'Versión premium del CS30 con pantalla secundaria para cliente y batería de 5000 mAh.', image: '/images/products/ciontek/cs30pro.png' },
      { name: 'CS50', type: 'Terminal POS', description: 'Terminal de sobremesa de alto rendimiento con doble pantalla y soporte multi-periférico.', image: '/images/products/ciontek/cs50.png' },
    ],
  },
]
